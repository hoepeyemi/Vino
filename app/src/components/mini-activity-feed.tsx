...
const ACTIVITY_MESSAGES = [
  ...
  { message: 'MockCVI.isVerified() gate: OK · all depositors verified', type: 'success' as const },
  { message: 'yield +$0.003 accrued', type: 'yield' as const },
  { message: 'pyth oracle: connected · MON/USD $0.082', type: 'success' as const },
  { message: 'CVA eligibility: verify_apass → USDC · USDT · EURC ✓', type: 'success' as const },
  { message: 'strategy scoring complete · confidence: 0.82', type: 'success' as const },
  { message: 'gas: ~100 Gwei base fee · Monad Testnet', type: 'info' as const },
  { message: 'yield +$0.002 accrued', type: 'yield' as const },
  { message: 'CVI gate: query_apass confirmed · Tier 1 · no frozen wallets', type: 'success' as const },
  { message: 'A-Token list refreshed · 3 CVA assets eligible', type: 'info' as const },
  { message: 'rebalance check: hold → conservative at confidence 0.76', type: 'info' as const },
  { message: 'FATF Rec-16 metadata cached · CVA rail: Cleanverse', type: 'info' as const },
