...
/// @title VinoPrivacy - Cryptographic commitments and Merkle proofs for invoice privacy
/// @notice Enables privacy-preserving verification of invoice data
/// @dev Part of vino Protocol - Uses hash commitments and Merkle trees for selective disclosure
